...
public class Map_01 extends BaseMap {
    ...
    public void addCollisionToMap() {
        ...
        addVerticalToObjectCollision(new Vector2[]{new Vector2(981,1890), new Vector2(893,2017), new Vector2(810,2049), new Vector2(557,1874), new Vector2(534,1474), new Vector2(891,1603)});
