...
public class Map_03 extends BaseMap {
    ...
    public static final Image MAP_IMAGE = new Image(new Texture(Gdx.files.internal("MAP_03.jpg")));
    public final static int MAP_WIDTH = (int)(MAP_IMAGE.getWidth() *0.80f);
    public final static int MAP_HEIGHT = (int)(MAP_IMAGE.getHeight() *0.80f);
