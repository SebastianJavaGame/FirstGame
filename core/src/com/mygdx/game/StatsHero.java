...
public class StatsHero {
    ...
    private void create() {
        ...
        barUp = new Image(new Texture(Gdx.files.internal("barX.png")));
        ...
        buttonAdd[0] = new ImageButton(new TextureRegionDrawable(new TextureRegion(new Texture("add.png"))));
        ...
        buttonAdd[1] = new ImageButton(new TextureRegionDrawable(new TextureRegion(new Texture("add.png"))));
        ...
        buttonAdd[2] = new ImageButton(new TextureRegionDrawable(new TextureRegion(new Texture("add.png"))));
        ...
        buttonAdd[3] = new ImageButton(new TextureRegionDrawable(new TextureRegion(new Texture("add.png"))));
        ...
        buttonAdd[4] = new ImageButton(new TextureRegionDrawable(new TextureRegion(new Texture("add.png"))));
        ...
        buttonAdd[5] = new ImageButton(new TextureRegionDrawable(new TextureRegion(new Texture("add.png"))));
