...
public class Map_05 extends BaseMap {
    ...
    public void addEntranceToMap() {
        //first entriance
        entriaceToMapRectangle.add(new Rectangle(1500, 500, 100, 100));
    ...
    public void addCollisionToMap() {
        ...
        addVerticalToObjectCollision(new Vector2[]{new Vector2(216,2267), new Vector2(1543,2183), new Vector2(1648,2220), new Vector2(1717,2234), new Vector2(1805,2238), new Vector2(1900,2207), new Vector2(1937,2214), new Vector2(2000,2220), new Vector2(2120,2181), new Vector2(2132,2092), new Vector2(2127,1872), new Vector2(2033,1761), new Vector2(2030,1499), new Vector2(2101,1458)});
