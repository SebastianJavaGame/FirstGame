...
public class Map_04 extends BaseMap {
    ...
    public void addEnemyToMap() {
        ...
        //Group 1
        for (int i = 0; i < 7; i++) {
            enemies[0][i] = new Enemy("enemy/map4/p1.png", "enemy/map4/1.png", "enemy/map4/w1.png", true, "Zombie dzik" ,50 ,      1900, 125, 105, 14.5f, 110, 100,        1, 5760, 1, 1);//740
        ...
        //Group 2
        for (int i = 0; i < 7; i++) {
            enemies[1][i] = new Enemy("enemy/map4/p2.png", "enemy/map4/2.png", "enemy/map4/w2.png", true, "Umarlak" ,52 ,       2000, 125, 130, 13.5f, 110, 110,      1, 6050, 1, 1);//775
        ...
        //Group 3
        for (int i = 0; i < 7; i++) {
            enemies[2][i] = new Enemy("enemy/map4/p3.png", "enemy/map4/3.png", "enemy/map4/w3.png", true, "Dinotop" ,54 ,          2000, 125, 130, 13.5f, 110, 110,      1, 6090, 1, 1);//800
        ...
        //Group 4
        for (int i = 0; i < 7; i++) {
            enemies[3][i] = new Enemy("enemy/map4/p4.png", "enemy/map4/4.png", "enemy/map4/w4.png", false, "Gonomet" ,55 ,      2300, 120, 100, 14f, 125, 100,         1, 6135, 1, 1);//805
        ...
        //Group 5
        for (int i = 0; i < 7; i++) {
            enemies[4][i] = new Enemy("enemy/map4/p5.png", "enemy/map4/5.png", "enemy/map4/5.png", false, "Bevter" ,57 ,        2450, 150, 100, 12f, 130, 115,      1, 6215, 1, 1);//845
        ...
        //Group 6
        for (int i = 0; i < 7; i++) {
            enemies[5][i] = new Enemy("enemy/map4/p6.png", "enemy/map4/6.png", "enemy/map4/w6.png", false, "Skvergan" ,58 ,      2700, 100, 150, 10f, 100, 145,      1, 6250, 1, 1);//850
        ...
        //Group 7
        for (int i = 0; i < 7; i++) {
            enemies[6][i] = new Enemy("enemy/map4/p7.png", "enemy/map4/7.png", "enemy/map4/w7.png", false, "Muzovert" ,60 ,     2800, 110, 160, 11f, 100, 125,        1, 6750, 1, 1);//870
        ...
        //Group 8
        for (int i = 0; i < 7; i++) {
            enemies[7][i] = new Enemy("enemy/map4/p8.png", "enemy/map4/8.png", "enemy/map4/w8.png", false, "Skarab" ,62 ,       3000, 135, 135, 11f, 100, 120,       1, 7150, 1, 1);//885
        ...
        //Group 9
        for (int i = 0; i < 7; i++) {
            enemies[8][i] = new Enemy("enemy/map4/p9.png", "enemy/map4/9.png", "enemy/map4/w9.png", false, "Krather" ,64 ,      3600, 170, 120, 10f, 140, 110,         1, 7500, 1, 1);//1000
        ...
        //Group 10
        for (int i = 0; i < 7; i++) {
            enemies[9][i] = new Enemy("enemy/map4/p10.png", "enemy/map4/10.png", "enemy/map4/w10.png", true, "Verdos" ,65 ,     3500, 180, 135, 10f, 140, 120,          1, 7580, 1, 1);//1025
