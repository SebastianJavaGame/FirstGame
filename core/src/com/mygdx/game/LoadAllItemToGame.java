...
public class LoadAllItemToGame {
    ...
    public static final void loadItems(){
        ITEMS.put("silver_sword", new Item("silver_sword", "Items/Silver_sword.png", "Miecz srebrnego błysku", Item.ItemType.WAPON, 1, 50, 5, 0, 6, 0, 0, 1000));
        ITEMS.put("gold_armor", new Item("gold_armor", "Items/Gold_armor.png", "Złoty pancerz nieśmiertelności", Item.ItemType.ARMOR, 2, 80, 0, 0, 0, 20, 20, 1500));
