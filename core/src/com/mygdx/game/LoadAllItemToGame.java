...
public class LoadAllItemToGame {
    ...
    public static final void loadItems(){
        ...
        ITEMS.put("wapons2", new Item("wapons2", "Items/wapons/2.png", "Grav", Item.ItemType.WAPON, 4,          20, 7, 2, 0, 2, 1, 600));
        ...
        ITEMS.put("armor7", new Item("armor7", "Items/armor/7.png", "dabbe", Item.ItemType.ARMOR, 30,           300, 12, 11, 3.8f, 29, 25, 65000));  //145
        ITEMS.put("armor8", new Item("armor8", "Items/armor/8.png", "voldron", Item.ItemType.ARMOR, 35,         340, 13, 11, 4.3f, 34, 30, 88000));  //165
        ITEMS.put("armor9", new Item("armor9", "Items/armor/9.png", "teahell", Item.ItemType.ARMOR, 40,         380, 14, 12, 5.0f, 40, 36, 110000)); //190
        ITEMS.put("armor10", new Item("armor10", "Items/armor/10.png", "arnsal", Item.ItemType.ARMOR, 45,       440, 14, 14, 5.7f, 46, 40, 160000));  //215
        ITEMS.put("armor11", new Item("armor11", "Items/armor/11.png", "ceretris", Item.ItemType.ARMOR, 50,     500, 14, 15, 6.4f, 48, 44, 230000));  //235
        ITEMS.put("armor12", new Item("armor12", "Items/armor/12.png", "manpur", Item.ItemType.ARMOR, 55,       540, 16, 17, 7.0f, 51, 47, 350000));  //255
        ITEMS.put("armor13", new Item("armor13", "Items/armor/13.png", "maendra", Item.ItemType.ARMOR, 60,      580, 17, 18, 7.6f, 53, 52, 450000));  //275
        ITEMS.put("armor14", new Item("armor14", "Items/armor/14.png", "varlin", Item.ItemType.ARMOR, 65,       620, 19, 18, 8.0f, 55, 55, 575000));  //290
        ITEMS.put("armor15", new Item("armor15", "Items/armor/15.png", "gheiterog", Item.ItemType.ARMOR, 70,    650, 20, 20, 8.4f, 58, 57, 700000));  //305
        ITEMS.put("armor16", new Item("armor16", "Items/armor/16.png", "kaliertare", Item.ItemType.ARMOR, 75,   700, 22, 21, 9.0f, 62, 60, 850000));  //327
        ITEMS.put("armor17", new Item("armor17", "Items/armor/17.png", "isgur", Item.ItemType.ARMOR, 80,        800, 25, 25, 10.0f, 65, 65, 1000000));  //??

        /**
         * Armor pay
         */
        //ITEMS.put("armor1pay", new Item("armor1pay", "Items/armor/1pay.png", "vay", Item.ItemType.ARMOR, 15,        220, 11, 10, 2.8f, 24, 20, 0.50));
        //ITEMS.put("armor2pay", new Item("armor2pay", "Items/armor/2pay.png", "varthall", Item.ItemType.ARMOR, 25,   350, 13, 11, 4.3f, 36, 32, 0.80));
        //ITEMS.put("armor3pay", new Item("armor3pay", "Items/armor/3pay.png", "kalleres", Item.ItemType.ARMOR, 36,   450, 15, 15, 5.9f, 48, 43, 1.20));
        //ITEMS.put("armor4pay", new Item("armor4pay", "Items/armor/4pay.png", "agonia", Item.ItemType.ARMOR, 50,     650, 20, 22, 8.8f, 55, 55, 2.25));
        //ITEMS.put("armor5pay", new Item("armor5pay", "Items/armor/5pay.png", "xergen", Item.ItemType.ARMOR, 65,     850, 30, 30, 11.5f, 65, 65, 3.90));

        /**
         * Helmet
         */
        ITEMS.put("helmet1", new Item("helmet1", "Items/helmet/1.png", "maramus", Item.ItemType.HELMET, 1,             0, 0, 0, 0.1f, 2, 2, 100));
        ITEMS.put("helmet2", new Item("helmet2", "Items/helmet/2.png", "rolax", Item.ItemType.HELMET, 6,             30, 4, 2, 0.4f, 7, 5, 1100)); //25
        ITEMS.put("helmet3", new Item("helmet3", "Items/helmet/3.png", "tesek", Item.ItemType.HELMET, 10,            60, 6, 4, 0.7f, 13, 9, 3100)); //45
        ITEMS.put("helmet4", new Item("helmet4", "Items/helmet/4.png", "mellasthegan", Item.ItemType.HELMET, 16,            110, 10, 10, 1.0f, 18, 11, 7500)); //70
        ITEMS.put("helmet5", new Item("helmet5", "Items/helmet/5.png", "redias", Item.ItemType.HELMET, 22,            160, 12, 14, 1.7f, 21, 15, 24000));  //95
        ITEMS.put("helmet6", new Item("helmet6", "Items/helmet/6.png", "keldarn", Item.ItemType.HELMET, 30,            290, 21, 18, 2.3f, 29, 25, 60000));  //145
        ITEMS.put("helmet7", new Item("helmet7", "Items/helmet/7.png", "geotaur", Item.ItemType.HELMET, 36,            360, 23, 21, 2.7f, 35, 33, 90000));  //175
        ITEMS.put("helmet8", new Item("helmet8", "Items/helmet/8.png", "irkhaml", Item.ItemType.HELMET, 40,            400, 23, 22, 3.0f, 38, 37, 100000));  //190
        ITEMS.put("helmet9", new Item("helmet9", "Items/helmet/9.png", "isvard", Item.ItemType.HELMET, 46,            480, 25, 24, 3.8f, 43, 43, 180000));  //220
        ITEMS.put("helmet10", new Item("helmet10", "Items/helmet/10.png", "marsarry", Item.ItemType.HELMET, 55,          550, 26, 25, 4.8f, 49, 48, 350000));  //255
        ITEMS.put("helmet11", new Item("helmet11", "Items/helmet/11.png", "irkemla", Item.ItemType.HELMET, 62,          600, 27, 27, 5.5f, 54, 53, 525000));  //280
        ITEMS.put("helmet12", new Item("helmet12", "Items/helmet/12.png", "kres", Item.ItemType.HELMET, 70,          650, 29, 29, 6.2f, 60, 56, 700000));  //305
        ITEMS.put("helmet13", new Item("helmet13", "Items/helmet/13.png", "gerthill", Item.ItemType.HELMET, 80,          700, 32, 32, 7.0f, 65, 65, 1000000)); //335

        /**
         * Helmet pay
         */
        //ITEMS.put("helmet1pay", new Item("helmet1pay", "Items/helmet/1pay.png", "Iskra", Item.ItemType.HELMET, 30,          480, 25, 24, 3.8f, 43, 43, 0.90));
        //ITEMS.put("helmet2pay", new Item("helmet2pay", "Items/helmet/2pay.png", "Valdren", Item.ItemType.HELMET, 60,          700, 35, 35, 7.0f, 65, 65, 2.90));
        ...
        ITEMS.put("ring8", new Item("ring8", "Items/ring/8.png", "khelem", Item.ItemType.RING, 36,              400, 29, 35, 0.2f, 26, 38, 90000));  //170
        ITEMS.put("ring9", new Item("ring9", "Items/ring/9.png", "nirt", Item.ItemType.RING, 42,              490, 36, 43, 0.4f, 31, 44, 110000));  //195
        ITEMS.put("ring10", new Item("ring10", "Items/ring/10.png", "allakaj", Item.ItemType.RING, 45,           570, 40, 45, 0.4f, 34, 47, 170000));  //215
        ITEMS.put("ring11", new Item("ring11", "Items/ring/11.png", "kerepeks", Item.ItemType.RING, 53,           630, 44, 49, 0.5f, 38, 53, 310000));  //240
        ITEMS.put("ring12", new Item("ring12", "Items/ring/12.png", "narthill", Item.ItemType.RING, 56,           680, 48, 52, 0.6f, 42, 56, 375000));  //260
        ITEMS.put("ring13", new Item("ring13", "Items/ring/13.png", "sphaera", Item.ItemType.RING, 60,           730, 52, 55, 0.6f, 43, 58, 475000));  //275
        ITEMS.put("ring14", new Item("ring14", "Items/ring/14.png", "szhaol", Item.ItemType.RING, 63,           750, 54, 55, 0.8f, 45, 60, 520000)); //285
        ITEMS.put("ring15", new Item("ring15", "Items/ring/15.png", "merkehm", Item.ItemType.RING, 69,           800, 55, 59, 0.9f, 46, 63, 680000));  //305
        ITEMS.put("ring16", new Item("ring16", "Items/ring/16.png", "wachar", Item.ItemType.RING, 74,           860, 58, 62, 1.1f, 48, 67, 860000));  //325
        ITEMS.put("ring17", new Item("ring17", "Items/ring/17.png", "velezen", Item.ItemType.RING, 80,           900, 60, 65, 1.5f, 50, 70, 1000000));  //??

        /**
         * Ring pay
         */
        //ITEMS.put("ring1pay", new Item("ring1pay", "Items/ring/1pay.png", "skra", Item.ItemType.RING, 20,              340, 24, 32, 0.5f, 24, 34, 0.60));
        //ITEMS.put("ring2pay", new Item("ring2pay", "Items/ring/2pay.png", "kriaring", Item.ItemType.RING, 45,              730, 52, 55, 0.6f, 43, 58, 1.90));
        //ITEMS.put("ring3pay", new Item("ring3pay", "Items/ring/3pay.png", "eatarus", Item.ItemType.RING, 60,              860, 58, 62, 1.1f, 47, 66, 2.90));
        ...
        ITEMS.put("shoes5", new Item("shoes5", "Items/shoes/5.png", "salany", Item.ItemType.SHOES, 30,           310, 28, 14, 2.7f, 28, 12, 66000)); //145
        ITEMS.put("shoes6", new Item("shoes6", "Items/shoes/6.png", "Viroklesy", Item.ItemType.SHOES, 36,           370, 34, 18, 3.2f, 34, 15, 92000)); //175
        ITEMS.put("shoes7", new Item("shoes7", "Items/shoes/7.png", "hetakamby", Item.ItemType.SHOES, 45,           450, 43, 25, 4.0f, 37, 20, 175000)); //215
        ITEMS.put("shoes8", new Item("shoes8", "Items/shoes/8.png", "sidveny", Item.ItemType.SHOES, 52,           500, 48, 31, 4.4f, 40, 28, 300000)); //245
        ITEMS.put("shoes9", new Item("shoes9", "Items/shoes/9.png", "iskremly", Item.ItemType.SHOES, 60,           540, 50, 35, 5.3f, 45, 34, 500000)); //275
        ITEMS.put("shoes10", new Item("shoes10", "Items/shoes/10.png", "Vartrogi", Item.ItemType.SHOES, 66,        580, 52, 37, 5.8f, 47, 37, 600000)); //290
        ITEMS.put("shoes11", new Item("shoes11", "Items/shoes/11.png", "itrimsy", Item.ItemType.SHOES, 72,        650, 60, 40, 6.5f, 55, 40, 820000)); //325

        /**
         * Shoes pay
         */
        //ITEMS.put("shoes1pay", new Item("shoes1pay", "Items/shoes/1pay.png", "holmy", Item.ItemType.SHOES, 55,           660, 60, 40, 6.8f, 55, 42, 1.90));
